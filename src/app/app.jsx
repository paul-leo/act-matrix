        ...
        <IonPage>
            ...
            <IonContent className={styles.content}>
                <IonCard className={styles.welcomeCard}>
                    ...
                    <IonCardContent>
                        <p>
                            This is a simple template that demonstrates the
                            basic structure of a MorphixAI app.
                        </p>
                        ...
                        <div className={styles.info}>
                            ...
                            <ul>
                                <li>
                                    ✅ Uses <code>app.jsx</code> as entry point
                                </li>
                                <li>
                                    ✅ Imports from <code>@ionic/react</code>
                                </li>
                                <li>
                                    ✅ Uses <code>@morphixai/components</code>
                                </li>
